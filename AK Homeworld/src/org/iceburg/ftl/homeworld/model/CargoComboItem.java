...
public class CargoComboItem {
	...
	public String toString() {
		...
		public static ArrayList<CargoComboItem> weaponToCombo(ShipState state, HashMap<String, Integer> map) {
		...
		public static ArrayList<CargoComboItem> augmentToCombo(ShipState state, HashMap<String, Integer> map) {
			ArrayList<CargoComboItem> al = new ArrayList<CargoComboItem>();	
		...
		public static ArrayList<CargoComboItem> droneToCombo(ShipState state, HashMap<String, Integer> map) {
			ArrayList<CargoComboItem> al = new ArrayList<CargoComboItem>();	
		...
		public static ArrayList<CargoComboItem> cargoToCombo(SavedGameState state, HashMap<String, Integer> map) {
			ArrayList<CargoComboItem> al = new ArrayList<CargoComboItem>();	
		...
		public static WeaponState getWSFromID( ArrayList<WeaponState> weaponList, String id){
			int i = 0;
			WeaponState ws= null;
		...
		public static DroneState getDSFromID( ArrayList<DroneState> droneList, String id){
			int i = 0;
			DroneState ds= null;
			while (i < droneList.size()){
				ds = droneList.get(i);
